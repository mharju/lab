...
lab.core.connect_BANG_ = (function lab$core$connect_BANG_(p__27851){
...
var host = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__27852__$1,new cljs.core.Keyword(null,"host","host",-1558485167),"localhost");
var port = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__27852__$1,new cljs.core.Keyword(null,"port","port",1534937262),(9898));
var temp__5735__auto__ = cljs.core.deref(lab.core.data_connection);
if(cljs.core.truth_(temp__5735__auto__)){
var map__27854 = temp__5735__auto__;
...
var ws = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27854__$1,new cljs.core.Keyword(null,"ws","ws",86841443));
if((!((ws == null)))){
return ws;
} else {
...
var map__27856 = (function (){try{return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(JSON.parse(e.data));
...
var message = map__27856__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27856__$1,"id");
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27856__$1,"data");
...
var seq__27871 = cljs.core.seq(cljs.core.vals(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(lab.core.data_connection),new cljs.core.Keyword(null,"listeners","listeners",394544445))));
var chunk__27872 = null;
var count__27873 = (0);
var i__27874 = (0);
while(true){
if((i__27874 < count__27873)){
var listener__$1 = chunk__27872.cljs$core$IIndexed$_nth$arity$2(null,i__27874);
...
var G__27906 = seq__27871;
var G__27907 = chunk__27872;
var G__27908 = count__27873;
var G__27909 = (i__27874 + (1));
seq__27871 = G__27906;
chunk__27872 = G__27907;
count__27873 = G__27908;
i__27874 = G__27909;
continue;
} else {
var temp__5735__auto____$1 = cljs.core.seq(seq__27871);
if(temp__5735__auto____$1){
var seq__27871__$1 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(seq__27871__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__27871__$1);
var G__27910 = cljs.core.chunk_rest(seq__27871__$1);
var G__27911 = c__4556__auto__;
var G__27912 = cljs.core.count(c__4556__auto__);
var G__27913 = (0);
seq__27871 = G__27910;
chunk__27872 = G__27911;
count__27873 = G__27912;
i__27874 = G__27913;
continue;
} else {
var listener__$1 = cljs.core.first(seq__27871__$1);
(listener__$1.cljs$core$IFn$_invoke$arity$1 ? listener__$1.cljs$core$IFn$_invoke$arity$1(message) : listener__$1.call(null,message));


var G__27914 = cljs.core.next(seq__27871__$1);
var G__27915 = null;
var G__27916 = (0);
var G__27917 = (0);
seq__27871 = G__27914;
chunk__27872 = G__27915;
count__27873 = G__27916;
i__27874 = G__27917;
continue;
}
} else {
...
var _STAR_print_newline_STAR__orig_val__27883_27918 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__27884_27919 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__27885_27920 = true;
var _STAR_print_fn_STAR__temp_val__27886_27921 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__27885_27920);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__27886_27921);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27880_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"lat","lat",-580793929).cljs$core$IFn$_invoke$arity$1(p1__27880_SHARP_),new cljs.core.Keyword(null,"lng","lng",1667213918).cljs$core$IFn$_invoke$arity$1(p1__27880_SHARP_)],null));
}),(function (latlngs){
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__27884_27919);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__27883_27918);
}
...
if(cljs.core.truth_((function (){var and__4115__auto__ = module$node_modules$jquery$dist$jquery("#pasteboard").is(":visible");
if(cljs.core.truth_(and__4115__auto__)){
...
var f = (goog.object.getValueByKeys(e,"dataTransfer","files")[(0)]);
return f.text().then((function (content){
if((cljs.core.count(content) >= (1024))){
cljs.core.reset_BANG_(lab.core.file_contents,content);

return goog.object.set(document.getElementById("drop-target"),"value",["Loaded ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.object.get(f,"name")),", size ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.count(content))," bytes."].join(''));
} else {
return goog.object.set(document.getElementById("drop-target"),"value",content);
}
}));
});
...
lab.core.maybe_save_default_BANG_ = (function lab$core$maybe_save_default_BANG_(form,p__27897){
var map__27898 = p__27897;
var map__27898__$1 = (((((!((map__27898 == null))))?(((((map__27898.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27898.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27898):map__27898);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27898__$1,new cljs.core.Keyword(null,"error","error",-978969032));
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["I maybe save here",form,"and",error], 0));
...
var drop_target_27923 = document.getElementById("drop-target");
drop_target_27923.addEventListener("drop",lab.core.handle_drop);

drop_target_27923.addEventListener("dragover",lab.core.handle_dragover);
...
var value = (function (){var or__4126__auto__ = cljs.core.deref(lab.core.file_contents);
...
var cm_27924 = lab.codemirror.init_BANG_();
lab.core.set_shortcuts_BANG_(cm_27924);

lab.layout.toggle_repl_BANG_.cljs$core$IFn$_invoke$arity$1(true);

cm_27924.setCursor(({"line": (3), "ch": (0)}));
