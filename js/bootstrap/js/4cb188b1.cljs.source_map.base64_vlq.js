...
var digit_21781 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_21782__$1 = (vlq >>> (5));
while(true){
if((vlq_21782__$1 > (0))){
var digit_21783__$1 = (digit_21781 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_21783__$1));

var G__21784 = (vlq_21782__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__21785 = (vlq_21782__$1 >>> (5));
digit_21781 = G__21784;
vlq_21782__$1 = G__21785;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_21781));
}
break;
}
...
var G__21786 = i__$1;
var G__21787 = result__$1;
var G__21788 = shift__$1;
i = G__21786;
result = G__21787;
shift = G__21788;
continue;
