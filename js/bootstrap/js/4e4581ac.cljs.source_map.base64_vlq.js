...
var digit_22122 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_22123__$1 = (vlq >>> (5));
while(true){
if((vlq_22123__$1 > (0))){
var digit_22124__$1 = (digit_22122 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_22124__$1));

var G__22125 = (vlq_22123__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__22126 = (vlq_22123__$1 >>> (5));
digit_22122 = G__22125;
vlq_22123__$1 = G__22126;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_22122));
}
break;
}
...
var G__22128 = i__$1;
var G__22129 = result__$1;
var G__22130 = shift__$1;
i = G__22128;
result = G__22129;
shift = G__22130;
continue;
