...
var lab$parsing$ICode$get_line$dyn_25641 = (function (this$,n){
...
return lab$parsing$ICode$get_line$dyn_25641(this$,n);
}
});

var lab$parsing$ICode$line_count$dyn_25642 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return lab$parsing$ICode$line_count$dyn_25642(this$);
}
});

var lab$parsing$ICode$get_range$dyn_25643 = (function (this$,start,end){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return lab$parsing$ICode$get_range$dyn_25643(this$,start,end);
}
});
...
(cljs.core.PersistentVector.prototype.lab$parsing$ICode$get_range$arity$3 = (function (this$,p__25573,p__25574){
var map__25575 = p__25573;
var map__25575__$1 = cljs.core.__destructure_map(map__25575);
var start_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25575__$1,new cljs.core.Keyword(null,"line","line",212345235));
var start_ch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25575__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
var map__25576 = p__25574;
var map__25576__$1 = cljs.core.__destructure_map(map__25576);
var end_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25576__$1,new cljs.core.Keyword(null,"line","line",212345235));
var end_ch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25576__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
var this$__$1 = this;
...
var G__25581 = cursor;
var map__25582 = G__25581;
var map__25582__$1 = cljs.core.__destructure_map(map__25582);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25582__$1,new cljs.core.Keyword(null,"line","line",212345235));
var ch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25582__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
var G__25581__$1 = G__25581;
while(true){
var map__25605 = G__25581__$1;
var map__25605__$1 = cljs.core.__destructure_map(map__25605);
var line__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25605__$1,new cljs.core.Keyword(null,"line","line",212345235));
var ch__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25605__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
...
if((line__$1 > (0))){
var G__25644 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",212345235),(line__$1 - (1)),new cljs.core.Keyword(null,"ch","ch",-554717905),cljs.core.count(lab.parsing.get_line(cm,(line__$1 - (1))))], null);
G__25581__$1 = G__25644;
continue;
} else {
return null;
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__25607,ch){
var map__25608 = p__25607;
var map__25608__$1 = cljs.core.__destructure_map(map__25608);
var counter__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25608__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25608__$1,new cljs.core.Keyword(null,"pos","pos",-864607220));
...
(lab.parsing.find_end_paren.cljs$core$IFn$_invoke$arity$2 = (function (cm,p__25623){
var map__25624 = p__25623;
var map__25624__$1 = cljs.core.__destructure_map(map__25624);
var cursor = map__25624__$1;
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25624__$1,new cljs.core.Keyword(null,"line","line",212345235));
var ch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25624__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
...
var G__25630 = cursor;
var map__25631 = G__25630;
var map__25631__$1 = cljs.core.__destructure_map(map__25631);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25631__$1,new cljs.core.Keyword(null,"line","line",212345235));
var ch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25631__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
var counter = counter_init;
var G__25630__$1 = G__25630;
var counter__$1 = counter;
while(true){
var map__25632 = G__25630__$1;
var map__25632__$1 = cljs.core.__destructure_map(map__25632);
var line__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25632__$1,new cljs.core.Keyword(null,"line","line",212345235));
var ch__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25632__$1,new cljs.core.Keyword(null,"ch","ch",-554717905));
var counter__$2 = counter__$1;
var current_line = lab.parsing.get_line(cm,line__$1).substring(ch__$1);
var map__25633 = lab.parsing.match_parens(counter__$2,current_line);
var map__25633__$1 = cljs.core.__destructure_map(map__25633);
var success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25633__$1,new cljs.core.Keyword(null,"success","success",1890645906));
var counter__$3 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25633__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25633__$1,new cljs.core.Keyword(null,"pos","pos",-864607220));
...
var G__25674 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",212345235),(line__$1 + (1)),new cljs.core.Keyword(null,"ch","ch",-554717905),(0)], null);
var G__25675 = counter__$3;
G__25630__$1 = G__25674;
counter__$1 = G__25675;
continue;
} else {
return null;
}
...
var G__25637 = cursor;
var map__25638 = G__25637;
var map__25638__$1 = cljs.core.__destructure_map(map__25638);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25638__$1,new cljs.core.Keyword(null,"line","line",212345235));
var G__25637__$1 = G__25637;
while(true){
var map__25639 = G__25637__$1;
var map__25639__$1 = cljs.core.__destructure_map(map__25639);
var line__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25639__$1,new cljs.core.Keyword(null,"line","line",212345235));
...
if(((line__$1 - (1)) > (0))){
var G__25676 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",212345235),(line__$1 - (1)),new cljs.core.Keyword(null,"ch","ch",-554717905),(0)], null);
G__25637__$1 = G__25676;
continue;
} else {
return null;
}
...
var G__25677 = end_cursor;
var G__25678 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(forms,form);
cursor = G__25677;
forms = G__25678;
continue;
} else {
...
var dcl = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((1),cljs.core.first(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__25640_SHARP_){
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__25640_SHARP_], 0));

return (((!(cljs.core.seq_QMARK_(p1__25640_SHARP_)))) || (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"require","require",-468001333),cljs.core.first(p1__25640_SHARP_))));
