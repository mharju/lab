...
(lab.graph.columnize.cljs$core$IFn$_invoke$arity$variadic = (function (data,column,value,p__26648){
...
var x_axis = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26649__$1,new cljs.core.Keyword(null,"x-axis","x-axis",-1736373253));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__26651){
...
var G__26656 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(columns,cljs.core.name((function (){var or__4126__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,column);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__26656,cljs.core.name(x_axis),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.conj,cljs.core.PersistentVector.EMPTY),cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,x_axis));
} else {
return G__26656;
}
...
/** @this {Function} */
(lab.graph.columnize.cljs$lang$applyTo = (function (seq26634){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26635,G__26636,G__26637,seq26634__$3);
}));
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function lab$graph$invalidate_size_BANG__$_iter__26659(s__26660){
return (new cljs.core.LazySeq(null,(function (){
var s__26660__$1 = s__26660;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__26660__$1);
if(temp__5735__auto__){
var s__26660__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26660__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__26660__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__26662 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__26661 = (0);
while(true){
if((i__26661 < size__4528__auto__)){
var vec__26666 = cljs.core._nth(c__4527__auto__,i__26661);
...
var g = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26669__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
...
if((!((g == null)))){
cljs.core.chunk_append(b__26662,(function (){
...
var G__26701 = (i__26661 + (1));
i__26661 = G__26701;
continue;
} else {
var G__26702 = (i__26661 + (1));
i__26661 = G__26702;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26662),lab$graph$invalidate_size_BANG__$_iter__26659(cljs.core.chunk_rest(s__26660__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26662),null);
}
} else {
var vec__26690 = cljs.core.first(s__26660__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26690,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26690,(1),null);
var map__26693 = v;
...
var g = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26693__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
var p = document.getElementById(cljs.core.name(k));
var width = goog.object.get(p,"clientWidth");
var height = goog.object.get(p,"clientHeight");
if((!((g == null)))){
...
,lab$graph$invalidate_size_BANG__$_iter__26659(cljs.core.rest(s__26660__$2)));
} else {
var G__26703 = cljs.core.rest(s__26660__$2);
s__26660__$1 = G__26703;
continue;
}
}
} else {
