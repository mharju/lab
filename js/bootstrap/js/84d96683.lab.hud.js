...
var timeout_26753 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
(lab.hud.show_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (message,p__26751){
var map__26752 = p__26751;
var map__26752__$1 = cljs.core.__destructure_map(map__26752);
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26752__$1,new cljs.core.Keyword(null,"duration","duration",1444101068),(3000));
var hud = $("#hud");
...
if(cljs.core.truth_(cljs.core.deref(timeout_26753))){
clearTimeout(timeout_26753);
} else {
}

hud.show().text(message__$1).addClass("visible");

return cljs.core.reset_BANG_(timeout_26753,setTimeout((function (){
...
/** @this {Function} */
(lab.hud.show_BANG_.cljs$lang$applyTo = (function (seq26749){
var G__26750 = cljs.core.first(seq26749);
var seq26749__$1 = cljs.core.next(seq26749);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26750,seq26749__$1);
}));
