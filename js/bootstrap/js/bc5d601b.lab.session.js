...
if(cljs.core.truth_((function (){var fexpr__26284 = cljs.core.set(lab.session.session_names);
return (fexpr__26284.cljs$core$IFn$_invoke$arity$1 ? fexpr__26284.cljs$core$IFn$_invoke$arity$1(name) : fexpr__26284.call(null,name));
})())){
...
var G__26285 = (function (){var or__4126__auto__ = window.localStorage.getItem(["session-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join(''));
...
var G__26285__$1 = (((G__26285 == null))?null:JSON.parse(G__26285));
if((G__26285__$1 == null)){
return null;
} else {
return [lab.session.help_text,cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26285__$1)].join('');
}
}
});
lab.session.session_load_display = (function lab$session$session_load_display(){
return ["<div","",">","<h2>Select a session to load</h2>",(function (){var attrs26288 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function lab$session$session_load_display_$_iter__26294(s__26295){
...
return iter__4529__auto__(lab.session.list_sessions_BANG_());
})());
if(cljs.core.map_QMARK_(attrs26288)){
return ["<div",cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccups.runtime.render_attr_map(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),null,new cljs.core.Keyword(null,"class","class",-2030961996),"options"], null),attrs26288], 0)))),">","</div>"].join('');
} else {
return ["<div class=\"options\">",cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccups.runtime.render_html(attrs26288)),"</div>"].join('');
}
})(),"</div>"].join('');
});
