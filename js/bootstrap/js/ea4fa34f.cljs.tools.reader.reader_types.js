...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_19842 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_19842(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_19854 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_19854(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19859 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19859(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19860 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19860(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19866 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19866(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19883 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19883(reader);
}
});
...
var G__19950 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__19951 = s.append(c);
c = G__19950;
s = G__19951;
continue;
}
