...
if(cljs.core.truth_((function (){var fexpr__25705 = cljs.core.set(lab.session.session_names);
return (fexpr__25705.cljs$core$IFn$_invoke$arity$1 ? fexpr__25705.cljs$core$IFn$_invoke$arity$1(name) : fexpr__25705.call(null,name));
})())){
...
var G__25706 = (function (){var or__4253__auto__ = window.localStorage.getItem(["session-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join(''));
...
var G__25706__$1 = (((G__25706 == null))?null:JSON.parse(G__25706));
if((G__25706__$1 == null)){
return null;
} else {
return [lab.session.help_text,cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25706__$1)].join('');
}
}
});
lab.session.session_load_display = (function lab$session$session_load_display(){
return ["<div","",">","<h2>Select a session to load</h2>",(function (){var attrs25709 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function lab$session$session_load_display_$_iter__25718(s__25719){
return (new cljs.core.LazySeq(null,(function (){
var s__25719__$1 = s__25719;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__25719__$1);
if(temp__5753__auto__){
var s__25719__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25719__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__25719__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__25721 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__25720 = (0);
while(true){
if((i__25720 < size__4651__auto__)){
var session = cljs.core._nth(c__4650__auto__,i__25720);
cljs.core.chunk_append(b__25721,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.option","div.option",-1520829790),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"onClick","onClick",-1991238530),["javascript:lab.core.load_session_BANG_(\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(session),"\"); lab.session.close_session_load_display_BANG_()"].join('')], null),session], null));

var G__25724 = (i__25720 + (1));
i__25720 = G__25724;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25721),lab$session$session_load_display_$_iter__25718(cljs.core.chunk_rest(s__25719__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25721),null);
}
} else {
var session = cljs.core.first(s__25719__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.option","div.option",-1520829790),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"onClick","onClick",-1991238530),["javascript:lab.core.load_session_BANG_(\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(session),"\"); lab.session.close_session_load_display_BANG_()"].join('')], null),session], null),lab$session$session_load_display_$_iter__25718(cljs.core.rest(s__25719__$2)));
}
} else {
return null;
}
